            ...
            <div class="box-body">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td class="col-md-2">Address 3</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.addresses.destroy', $address->id) }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('admin.customers.address.show', [$customer->id, $address->id]) }}" class="btn btn-default btn-sm"><i class="fa fa-eye"></i> Show</a>
                                        <a href="{{ route('admin.customers.address.edit', [$customer->id, $address->id]) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
